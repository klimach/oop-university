    ...
    namespace RGR.Controllers
    {
        public class DBController
        {
            ...
            public void AddPerson(Person person)
            {
                ...
                cmd.Parameters.AddWithValue("@PassportIssueDate", 
                    person.PassportIssueDate ?? "");
                cmd.Parameters.AddWithValue("@PassportIssuedBy", 
            ...
            public void UpdatePerson(Person person)
            {
                ...
                cmd.Parameters.AddWithValue("@Email", person.Email);
                cmd.Parameters.AddWithValue("@PassportNumber", 
                    (object?)person.PassportNumber ?? DBNull.Value);
                cmd.Parameters.AddWithValue("@PassportIssueDate", 
                    (object?)person.PassportIssueDate ?? DBNull.Value);
                cmd.Parameters.AddWithValue("@PassportIssuedBy", 
                    (object?)person.PassportIssuedBy ?? DBNull.Value);
                cmd.Parameters.AddWithValue("@JobTitle", 
                    (object?)person.JobTitle ?? DBNull.Value);
                cmd.Parameters.AddWithValue("@Organization", 
                    (object?)person.Organization ?? DBNull.Value);
                ...
                using (SQLiteConnection connection = new(_connectionString))
                {
                    ...
                    while (reader.Read())
                    {
                        Person person = new()
                        {
                            ...
                            null : reader["MiddleName"].ToString(),
                            Gender = reader["Gender"].ToString()!,
                            BirthDate = reader["BirthDate"].ToString()!,
                            Address = reader["Address"].ToString()!,
                            Phone = reader["Phone"].ToString()!,
                            Email = reader["Email"].ToString()!,
                            PassportNumber = reader["PassportNumber"] == DBNull.Value ? 
                            null : reader["PassportNumber"].ToString(),
                            PassportIssueDate = reader["PassportIssueDate"] == DBNull.Value ? 
                            null : reader["PassportIssueDate"].ToString(),
                            PassportIssuedBy = reader["PassportIssuedBy"] == DBNull.Value ? 
                            null : reader["PassportIssuedBy"].ToString(),
                            JobTitle = reader["JobTitle"] == DBNull.Value ? 
                            null : reader["JobTitle"].ToString(),
                            Organization = reader["Organization"] == DBNull.Value ? 
                            null : reader["Organization"].ToString()
                        };
